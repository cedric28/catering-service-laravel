        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                    <h2 class="block-title color-white text-center"> Special Menu</h2>
                ...
                <div class="special-box">
                    <div id="owl-demo">
                        <div class="item item-type-zoom">
                            ...
                            <div class="item-img">
                                <img src="{{ asset('landing-assets/images/special-menu-1.jpg') }}" alt="sp-menu">
                            </div>
                        </div>
                        <div class="item item-type-zoom">
                            <a href="#" class="item-hover">
                            ...
                            <div class="item-img">
                                <img src="{{ asset('landing-assets/images/special-menu-2.jpg') }}" alt="sp-menu">
                            </div>
                        </div>
                        <div class="item item-type-zoom">
                            <a href="#" class="item-hover">
                            ...
                            <div class="item-img">
                                <img src="{{ asset('landing-assets/images/special-menu-3.jpg') }}" alt="sp-menu">
                            </div>
                        </div>
                        <div class="item item-type-zoom">
                            <a href="#" class="item-hover">
