                ...
                <div class="team-box">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="sf-team">
                                <div class="thumb">
                                    <a href="#"><img src="{{ asset('landing-assets/images/staff-01.jpg') }}" alt=""></a>
                                </div>
                                <div class="text-col">
                                    <h3>John Doggett</h3>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="sf-team">
                                <div class="thumb">
                                    <a href="#"><img src="{{ asset('landing-assets/images/staff-02.jpg') }}" alt=""></a>
                                </div>
                                <div class="text-col">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="sf-team">
                                <div class="thumb">
                                    <a href="#"><img src="{{ asset('landing-assets/images/staff-03.jpg') }}" alt=""></a>
                                </div>
                                <div class="text-col">
                                    <h3>Monica Reyes</h3>
                                    <p>Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Aenean commodo ligula.</p>
