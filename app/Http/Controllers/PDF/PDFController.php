...
class PDFController extends Controller
{
    public function generateInvoice(Request $request, $id)
    {
        ...
        $log = new Log();
        $log->log = "User " . \Auth::user()->email . " generate Invoice " . $planner->or_no . " at " . Carbon::now();
    ...
    public function generateContract(Request $request, $id)
    {
        ...
        $log = new Log();
        $log->log = "User " . \Auth::user()->email . " generate Contract " . $planner->or_no . " at " . Carbon::now();
        $log->creator_id =  \Auth::user()->id;
        $log->updater_id =  \Auth::user()->id;
        $log->save();
    ...
    public function printBEO(Request $request, $id)
    {
        ...
        $log = new Log();
        $log->log = "User " . \Auth::user()->email . " print BEO Report at " . Carbon::now();
        $log->creator_id =  \Auth::user()->id;
        $log->updater_id =  \Auth::user()->id;
        $log->save();
    ...
    public function generateEmployeeActivity(Request $request)
    {
        ...
        $log = new Log();
        $log->log = "User " . \Auth::user()->email . " generate Employee Activities Report at " . Carbon::now();
        $log->creator_id =  \Auth::user()->id;
        $log->updater_id =  \Auth::user()->id;
        $log->save();
    ...
    public function printEmployeeActivity(Request $request)
    {
        ...
        $log = new Log();
        $log->log = "User " . \Auth::user()->email . " print Employee Activities Report at " . Carbon::now();
        $log->creator_id =  \Auth::user()->id;
        $log->updater_id =  \Auth::user()->id;
        $log->save();
